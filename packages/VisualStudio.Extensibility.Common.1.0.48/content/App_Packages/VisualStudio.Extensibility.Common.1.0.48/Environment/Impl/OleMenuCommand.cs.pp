...
{
	public class OleMenuCommandEventArgs : EventArgs
	{
		public OleMenuCommandEventArgs()
		{
		}

		public OleMenuCommandEventArgs(OleMenuCommand command)
		{
			Command = command;
		}

		public OleMenuCommand Command { get; set; }
	}
	...
	/// </summary>
	internal class OleMenuCmdEventArgs : EventArgs
	{
	...
	public class OleMenuCommand : MenuCommand, IOleMenuCommand, IMenuCommandInvokeEx
	{
		...
		/// </summary>
		private EventHandler<OleMenuCommandEventArgs> beforeQueryStatusHandler;
		private string text;
		...
		/// <param name="id">ID of the command.</param>
		public OleMenuCommand(EventHandler invokeHandler, EventHandler changeHandler, EventHandler<OleMenuCommandEventArgs> beforeQueryStatus, CommandID id) :
			base(invokeHandler, id)
		{
		...
		/// <param name="id">ID of the command.</param>
		/// <param name="Text">The text of the command.</param>
		public OleMenuCommand(EventHandler invokeHandler, EventHandler changeHandler, EventHandler<OleMenuCommandEventArgs> beforeQueryStatus, CommandID id, string Text) :
			base(invokeHandler, id)
		{
			PrivateInit(invokeHandler, changeHandler, beforeQueryStatus, Text);
		}

		private void PrivateInit(EventHandler handler, EventHandler changeHandler, EventHandler<OleMenuCommandEventArgs> beforeQS, string Text)
		{
			execHandler = handler;
		...
		public event EventHandler<OleMenuCommandEventArgs> BeforeQueryStatus
		{
		...
		public override int OleStatus
		{
			...
			get
			{
				...
				{
					beforeQueryStatusHandler(this, new OleMenuCommandEventArgs(this));
				}
		...
		public override void Invoke(object inArg)
		{
			try
			{
				OleMenuCmdEventArgs args = new OleMenuCmdEventArgs(inArg, new IntPtr(-1));
